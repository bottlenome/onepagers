...
| [Bonsai Chat](bonsai-chat/index.html) | tool | wip | 三値(1.58bit)/1bit LLM の Bonsai ファミリー7種(0.5B〜8B, DL 0.27〜2.3GB)を自作WebGPUカーネルで低ビットのままブラウザ実行。MLX量子化・Qwen3(QK-norm/YaRN)・チャットUI対応、重みパック〜トークナイザまで全自前 |

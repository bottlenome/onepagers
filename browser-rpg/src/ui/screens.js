  ...
  return `
    <div class="battle-enemy">
      ...
      <div style="display:flex;align-items:center;justify-content:center;gap:8px">
        ...
        <button class="btn small" style="font-size:0.7rem;padding:2px 6px" data-a="battlespeed">${G.settings.battleSpeed <= 200 ? '通常速度' : '高速'}</button>
      </div>
  ...
  return `
    ...
    <div class="panel">
      <p class="text-muted mb-1">${advanced
        ...
        : '転職するとLv.1に戻りますが、鍛えた力の一部は身体に残ります。'}</p>
